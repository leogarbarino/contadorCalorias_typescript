...
export default function ActivityList({activities, dispatch}: ActivityListProps) {
  ...
  return (
    <>
      <h2 className="text-4xl font-bold text-slate-600 text-center">Alimentación y Actividades</h2>
      { activities.length === 0 ? <p className="text-center my-5">No hay actividades ni alimentación registradas aún ...</p> :
